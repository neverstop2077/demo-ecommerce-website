    ...
    <div class="row">
        <div class="col-md-7 col-sm-6 col-12">
            <div class="card card-product">
                <img class="card-img-content" src="r1.jpg" alt="PLAID PANTS - RED 1">
                <img class="card-img-content" src="r2.jpg" alt="PLAID PANTS - RED 2">
                <img class="card-img-content" src="r3.jpg" alt="PLAID PANTS - RED 3">
            </div>
        </div>
        <div class="col-md-5 col-sm-6 col-12" style="text-align: left;">
            ...
            <?php
              ...
              $sql = "select soluonghang from hanghoa where tenhh='PLAID PANTS - RED'";
