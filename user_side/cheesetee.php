...
<div class="container text-center">
    <div class="row">
        <div class="col-md-7 col-sm-6 col-12">
            <div class="card card-product">
                  <img class="card-img-content" src="cheese1.jpg" alt="big cheese tee">
                  <img class="card-img-content" src="cheese2.jpg" alt="big cheese tee">
                  <img class="card-img-content" src="cheese3.jpg" alt="big cheese tee">
                  <img class="card-img-content" src="cheese4.jpg" alt="big cheese tee">
                  <img class="card-img-content" src="cheese5.jpg" alt="big cheese tee">
                  <img class="card-img-content" src="cheese6.jpg" alt="big cheese tee">
                  <img class="card-img-content" src="cheese7.jpg" alt="big cheese tee">
            </div>
        </div>
        <div class="col-md-5 col-sm-6 col-12" style="text-align: left;">
            <br><br>
            <div id="chitiet">
                <h5>STR8UP <span class="glyphicon glyphicon-euro"></span></h4>
                <h1>BIG "CHEESE" 8</h1>
                <h2>320,000₫</h5>
            </div>
            <div id="mota">
            ...
            <?php
              ...
              $sql = "select soluonghang from hanghoa where tenhh='BIG CHEESE 8'";
    ...
    <div class="row">
      <form action="musictee.php" method="post">
        <div class="col-md-4 col-sm-6 col-12">
          <div class="card card-product mb-3">
            <img class="card-img-top" src="ms1.jpg" alt="music love peace tee">
            <div class="card-body">
              <h5 class="card-title">'Music Love Peace' TEE</h5>
