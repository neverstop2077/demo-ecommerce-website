...
<html lang="en">
<head>
  <title>SIDE STRIPE PANTS - WHITE</title>
  <meta charset="utf-8">
    ...
    <div class="row">
        <div class="col-md-7 col-sm-6 col-12">
            <div class="card card-product">
                <img class="card-img-content" src="w1.jpg" alt="SIDE STRIPE PANTS - WHITE">
                <img class="card-img-content" src="w2.jpg" alt="SIDE STRIPE PANTS - WHITE">
                <img class="card-img-content" src="w3.jpg" alt="SIDE STRIPE PANTS - WHITE">
                <img class="card-img-content" src="w4.jpg" alt="SIDE STRIPE PANTS - WHITE">
            </div>
        </div>
        <div class="col-md-5 col-sm-6 col-12" style="text-align: left;">
            ...
            <?php
              ...
              $sql = "select soluonghang from hanghoa where tenhh='SIDE STRIPE PANTS - WHITE'";
