...
<html lang="en">
<head>
  <title>ULTRAMANIA Longsleeve Tee</title>
  <meta charset="utf-8">
    ...
    <div class="row">
        <div class="col-md-7 col-sm-6 col-12">
            <div class="card card-product">
                <img class="card-img-content" src="s1.jpg" alt="Longsleeve tee 1">
                <img class="card-img-content" src="s2.jpg" alt="Longsleeve tee 2">
                <img class="card-img-content" src="s3.jpg" alt="Longsleeve tee 3">
                <img class="card-img-content" src="s4.jpg" alt="Longsleeve tee 4">
            </div>
        </div>
        <div class="col-md-5 col-sm-6 col-12" style="text-align: left;">
            <br><br>
            <div id="chitiet">
                <h5>SAIGONZUP STORE <span class="glyphicon glyphicon-euro"></span></h4>
                <h1>ULTRAMANIA Longsleeve Tee</h1>
                <h2>280,000₫</h5>
            </div>
            <div id="mota">
            ...
            <?php
              ...
              $sql = "select soluonghang from hanghoa where tenhh='ULTRAMANIA Longsleeve Tee'";
