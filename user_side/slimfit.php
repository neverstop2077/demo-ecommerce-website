...
<div class="container text-center">
    <div class="row">
        <div class="col-md-7 col-sm-6 col-12">
            <div class="card card-product">
                <img class="card-img-content" src="f1.jpg" alt="Quần Tây Slim-Fit">
                <img class="card-img-content" src="f2.jpg" alt="Quần Tây Slim-Fit">
                <img class="card-img-content" src="f3.jpg" alt="Quần Tây Slim-Fit">
                <img class="card-img-content" src="f4.jpg" alt="Quần Tây Slim-Fit">
                <img class="card-img-content" src="f5.jpg" alt="Quần Tây Slim-Fit">
            </div>
        </div>
        <div class="col-md-5 col-sm-6 col-12" style="text-align: left;">
            <br><br>
            <div id="chitiet">
                <h5>ICON DENIM <span class="glyphicon glyphicon-euro"></span></h4>
                <h1>Quần Tây Slim-Fit Phối Đai Lưng Dù</h1>
                <h2>414,000₫</h5>
            </div>
            <div id="mota">
            ...
            <?php
              ...
              $sql = "select soluonghang from hanghoa where tenhh='Quần Tây Slim-Fit'";
    ...
    <div class="row">
      ...
      <form action="greypants.php" method="post">
        <div class="col-md-4 col-sm-6 col-12">
          <div class="card card-product mb-3">
            <img class="card-img-top" src="g1.jpg" alt="JOGGER PANTS - GREY">
            <div class="card-body">
              <h5 class="card-title">JOGGER PANTS - GREY</h5>
              <p class="card-text">420,000₫</p>
              <button type="submit" class="btn btn-default">Xem sản phẩm</button>
            </div>
          </div>
        </div>
