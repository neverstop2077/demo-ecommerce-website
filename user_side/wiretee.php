...
<html lang="en">
<head>
  <title>MYO Barbeb Wire TEE</title>
  <meta charset="utf-8">
    ...
    <div class="row">
        <div class="col-md-7 col-sm-6 col-12">
            <div class="card card-product">
                <img class="card-img-content" src="b1.jpg" alt="MYO Barbeb Wire TEE 1">
                <img class="card-img-content" src="b2.jpg" alt="MYO Barbeb Wire TEE 2">
                <img class="card-img-content" src="b3.jpg" alt="MYO Barbeb Wire TEE 3">
            </div>
        </div>
        <div class="col-md-5 col-sm-6 col-12" style="text-align: left;">
            <br><br>
            <div id="chitiet">
                <h5>MYO <span class="glyphicon glyphicon-euro"></span></h4>
                <h1>Áo Thun Tay Lỡ MYO Michelangelo's David</h1>
                <h2>525,000₫</h5>
            </div>
            <div id="mota">
            ...
            <?php
              ...
              $sql = "select soluonghang from hanghoa where tenhh='MYO Barbeb Wire TEE'";
