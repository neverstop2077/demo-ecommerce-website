...
<?php
    ...
    $sql1="insert into nhavien values('NV" . mt_rand(100,999) 
        . "','" . $_POST['hotennv']
        . "','" . $_POST['chucvu']
        . "','" . $_POST['diachi']
        . "','" . $_POST['sodienthoai'] . "');";
    $result1 = mysqli_query($conn, $sql1) or die("Thêm nhân viên thất bại");
    $sql = "SELECT * FROM `nhavien` where hotennv='" . $_POST['hotennv'] ."';";
    $result = mysqli_query($conn,$sql) or die("Không thể truy vấn nhân viên");
    echo '<div class="container">';
    echo '<h3 class="text-center">THÊM NHÂN VIÊN THÀNH CÔNG</h3><br>';
