...
<?php
    ...
    $sql1="insert into hanghoa values('HH" . mt_rand(1000,9999) 
        . "','" . $_POST['tenhh']
        . "','1 cái','" . $_POST['gia']
        . "','"  . $_POST['soluonghang']
        . "','"  . $_POST['maloai']
        . "','" . $_POST['ghichu'] . "');";
    $result1 = mysqli_query($conn, $sql1) or die("Thêm hàng hóa thất bại");
    ...
    echo '<h3 class="text-center">THÊM HÀNG HÓA THÀNH CÔNG</h3><br>';
