...
<?php
    ...
    if(!empty($_POST['bill'])){
        if(!empty($_POST['date_bill'])){
            ...
            where dh.sodondh=ct.sodondh and dh.sodondh='" . $_POST['bill'] . "' and dh.ngaydh='". $_POST['date_bill'] ."' order  by dh.ngaydh DESC ";
        }
        else{
            $sql="select dh.sodondh,dh.mskh,dh.ngaydh,dh.ngaygh,ct.mshh,ct.soluong,ct.giadathang from dathhang as dh, chitietdathang as ct
            where dh.sodondh=ct.sodondh and dh.sodondh='" . $_POST['bill'] . "' order  by dh.ngaydh DESC ";
        }
    }
    else{
        if(!empty($_POST['date_bill'])){
            $sql="select dh.sodondh,dh.mskh,dh.ngaydh,dh.ngaygh,ct.mshh,ct.soluong,ct.giadathang from dathhang as dh, chitietdathang as ct
            where dh.sodondh=ct.sodondh and dh.ngaydh='". $_POST['date_bill'] ."' order  by dh.ngaydh DESC ";
        }
        else{
            $sql="select dh.sodondh,dh.mskh,dh.ngaydh,dh.ngaygh,ct.mshh,ct.soluong,ct.giadathang from dathhang as dh, chitietdathang as ct
    ...
    $result=mysqli_query($conn,$sql) or die("Khong the thuc hien truy van");
