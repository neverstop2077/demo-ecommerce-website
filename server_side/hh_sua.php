...
<?php
    ...
    $sql1="update hanghoa set soluonghang=" .$_POST['soluong']." where mshh='". $_POST['ma']. "';";
    $result1 = mysqli_query($conn, $sql1) or die("sửa hàng hóa thất bại");
    ...
    echo '<h3 class="text-center">CẬP NHẬT SỐ LƯỢNG HÀNG HÓA THÀNH CÔNG</h3><br>';
